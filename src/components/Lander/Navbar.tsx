  ...
  const renderMobileNavigation = () => (
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="group z-20 flex items-center rounded-full bg-white/80 px-3 py-2 text-sm font-medium text-zinc-800 shadow-xl backdrop-blur-md dark:bg-zinc-800/80 dark:text-zinc-200"
